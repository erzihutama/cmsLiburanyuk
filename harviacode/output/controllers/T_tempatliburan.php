...
class T_tempatliburan extends MY_Controller
{
    ...
    public function index()
    {
      ...
      $data = array(
        'contain_view' => '{namamodule}/t_tempatliburan/t_tempatliburan_list',
    ...
    public function create(){
      $data = array(
        'contain_view' => '{namamodule}/t_tempatliburan/t_tempatliburan_form',
        ...
        'action'=>'{namamodule}/t_tempatliburan/create_action',
        'module'=>'{namamodule}',
        'titlePage'=>'t_tempatliburan',
        'controller'=>'t_tempatliburan'
       );
    ...
    public function edit($id){
      ...
      $data = array(
        'contain_view' => '{namamodule}/t_tempatliburan/t_tempatliburan_edit',
        'sidebar'=>'{namamodule}/sidebar',//Ini buat menu yang ditampilkan di module admin {DIKIRIM KE TEMPLATE}
        'css'=>'{namamodule}/crudassets/css',//Ini buat kirim css dari page nya  {DIKIRIM KE TEMPLATE}
        'script'=>'{namamodule}/crudassets/script',//ini buat javascript apa aja yang di load di page {DIKIRIM KE TEMPLATE}
        'action'=>'{namamodule}/t_tempatliburan/update_action',
        'dataedit'=>$dataedit,
        'module'=>'{namamodule}',
        'titlePage'=>'t_tempatliburan',
        'controller'=>'t_tempatliburan'
    ...
    public function create_action()
    {
		...
		'jam' => $this->input->post('jam',TRUE),
            ...
            redirect(site_url('{namamodule}/t_tempatliburan'));
        }
    }
